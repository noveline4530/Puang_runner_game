...
#	$Puang.collision_layer = 0
#	$Puang.set_collision_layer_bit(CollisionLayers.Layers.PUANG, true)
#	$Puang.collision_mask = 0
#	$Puang.set_collision_mask_bit(CollisionLayers.Layers.WALL, true)
#	$Puang.contacts_reported = 10
#	$Puang.contact_monitor = true
#
